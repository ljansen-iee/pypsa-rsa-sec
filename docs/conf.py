...
latex_documents = [
    (master_doc, "PyPSA-ZA.tex", "PyPSA-ZA Documentation", "author", "manual"),
]
...
rinoh_documents = [
    (
        ...
        "PyPSA-ZA",  # output (target.pdf)
        "PyPSA-ZA Documentation",  # document title
        "author",
    )
]  # document author
...
man_pages = [(master_doc, "pypsa-za", "PyPSA-ZA Documentation", [author], 1)]
